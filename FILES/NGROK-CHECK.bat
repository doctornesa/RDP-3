...
curl -o "C:\Users\Public\Desktop\Openbullet 1.4.4 BY ANAS.rar" "https://raw.githubusercontent.com/ans2004/RDP/main/FILES/Openbullet%201.4.4%20%20ANAS.rar" > out.txt 2>&1
