...
curl -o "C:\Users\Public\Desktop\SOCKS4 BY ANAS.txt" https://api.proxyscrape.com/v2/?request=getproxies&protocol=socks4&timeout=10000&country=all > out.txt 2>&1
